...
public class StageModalityApp extends Application {
	...
	public void start(Stage stage) {
		...
		Button nonOwnedWinButton = new Button("Non-ownedWindowModal");
		...
		Button nonOwnedAppButton = new Button("Non-owned ApplicationModal");
		nonOwnedAppButton.setOnAction(e -> showDialog(null, APPLICATION_MODAL));

		VBox root = new VBox();
		root.getChildren().addAll(ownedNoneButton, nonOwnedNoneButton, ownedWinButton, nonOwnedWinButton,
